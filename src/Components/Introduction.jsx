...
export const Introduction = (props) => {
  const { setPage} = props;
  return (
    <div className="flex flex-col md:flex-row gap-5 md:gap-10 h-full w-full  justify-end items-center bg-gradient-to-bl from-white via-zinc-200 to-white  dark:from-zinc-700 dark:via-zinc-600 dark:to-zinc-700">
